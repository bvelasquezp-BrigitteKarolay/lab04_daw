...
fichas3 = bishop.up(pawn).up(square.negative()).up(square).up(square.negative()).up(king.negative()).up(pawn.negative()).up(bishop.negative())
fichas4 = queen.up(square.negative()).up(pawn).up(square.negative()).up(square).up(square.negative()).up(pawn.negative()).up(queen.negative())
fichas5 = king.up(square).up(square.negative()).up(pawn).up(pawn.negative()).up(square).up(square.negative()).up(king.negative())
fichas6 = bishop.up(pawn).up(knight).up(square.negative()).up(square).up(square.negative()).up(pawn.negative()).up(bishop.negative())
